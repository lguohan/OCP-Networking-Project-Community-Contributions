...
typedef enum _sai_acl_table_attr_t
{
    ...
    SAI_ACL_TABLE_ATTR_FIELD_ACL_LOOKUP_USER_META,
    ...
    /* DST IP address match in L3 Table */
    SAI_ACL_TABLE_ATTR_FIELD_L3_DST_NPU_META_HIT,

    /* End of Table Match Field */
    SAI_ACL_TABLE_ATTR_FIELD_END = SAI_ACL_TABLE_ATTR_FIELD_L3_DST_NPU_META_HIT,
...
typedef enum _sai_acl_entry_attr_t
{
    ...
    /* Meta Data carried from previous ACL Stage
     * Value must be in the range defined in
     * SAI_SWITCH_ATTR_ACL_LOOKUP_USER_META_DATA_RANGE */
    SAI_ACL_ENTRY_ATTR_FIELD_ACL_LOOKUP_USER_META,
    ...
    /* DST IP address match in L3 Table */
    SAI_ACL_ENTRY_ATTR_FIELD_L3_NPU_META_DST_HIT,

    /* End of Rule Match Fields */
    SAI_ACL_ENTRY_ATTR_FIELD_END = SAI_ACL_ENTRY_ATTR_FIELD_L3_NPU_META_DST_HIT,
     ...
     * [sai_uint32_t]
     * Value Range SAI_SWITCH_ATTR_ACL_LOOKUP_USER_META_DATA_RANGE */
    SAI_ACL_ENTRY_ATTR_ACTION_SET_ACL_METADATA,

    /* End of Rule Actions */
    SAI_ACL_ENTRY_ATTR_ACTION_END = SAI_ACL_ENTRY_ATTR_ACTION_SET_ACL_METADATA
